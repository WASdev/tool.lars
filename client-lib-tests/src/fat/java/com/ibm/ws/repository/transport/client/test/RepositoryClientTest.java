...
public class RepositoryClientTest {
    ...
    protected static RepositoryReadableClient _client;
    protected static RepositoryWriteableClient _writeableClient; // Used for creating the repo and tidying up
    protected static RepositoryReadableClient _unauthenticatedClient;
    ...
    public RepositoryClientTest(RepositoryFixture fixture) {
