...
public class RestClientTest {
    ...
    private final RepositoryReadableClient _client;
    private final RepositoryWriteableClient _writeableClient;
    private final RepositoryReadableClient _unauthenticatedClient;
    ...
    public RestClientTest(RepositoryFixture fixture) {
