...
public class DataModelSerializerTest {
    ...
    public void testSerializeBadlyNamedClass() throws IOException {
        String result;
        Object testGetters = new getString();
        result = DataModelSerializer.serializeAsString(testGetters);
    ...
    public void testValidation() throws Exception {
        WlpInformation test = DataModelSerializer.deserializeObject(new ByteArrayInputStream("{ \"wlpInformationVersion\":\"1.1\"}".getBytes()), WlpInformation.class);
        assertEquals("Wrong version", "1.1", test.getWlpInformationVersion());

        try {
            test = DataModelSerializer.deserializeObject(new ByteArrayInputStream("{ \"wlpInformationVersion\":\"0.9\"}".getBytes()), WlpInformation.class);
        ...
        try {
            test = DataModelSerializer.deserializeObject(new ByteArrayInputStream("{ \"wlpInformationVersion\":\"2.0\"}".getBytes()), WlpInformation.class);
    ...
    public void testVisibility() throws Exception {
        WlpInformation test = DataModelSerializer.deserializeObject(new ByteArrayInputStream("{ \"wlpInformationVersion\":\"1.0\", \"visibility\":\"INSTALL\"}".getBytes()),
    ...
    public void testItsOkNotToHaveAVersion() throws Exception {
        JustAnotherBean test = DataModelSerializer.deserializeObject(new ByteArrayInputStream("{ \"field\":\"muddy\"}".getBytes()), JustAnotherBean.class);
    ...
    public void testDeserializeOkWithUnwantedFieldPresent() throws IOException, BadVersionException {
        ...
        try {
            ...
            try {
                DataModelSerializer.IGNORE_UNKNOWN_FIELDS = false;
                UnwantedFieldsTest uftx = DataModelSerializer.deserializeObject(new ByteArrayInputStream("{fred:\"fish fish\",barney:21}".getBytes()), UnwantedFieldsTest.class);
