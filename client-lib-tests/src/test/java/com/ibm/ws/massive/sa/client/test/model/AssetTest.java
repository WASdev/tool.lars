...
package com.ibm.ws.massive.sa.client.test.model;
...
import com.ibm.ws.massive.sa.client.model.AbstractJSON;
import com.ibm.ws.massive.sa.client.model.AppliesToFilterInfo;
import com.ibm.ws.massive.sa.client.model.Asset;
import com.ibm.ws.massive.sa.client.model.AssetInformation;
...
import com.ibm.ws.massive.sa.client.model.ImageDetails;
import com.ibm.ws.massive.sa.client.model.Link;
import com.ibm.ws.massive.sa.client.model.PricingInformation;
import com.ibm.ws.massive.sa.client.model.PublishedInformation;
import com.ibm.ws.massive.sa.client.model.Reviewed;
import com.ibm.ws.massive.sa.client.model.SalesContact;
import com.ibm.ws.massive.sa.client.model.StateAction;
import com.ibm.ws.massive.sa.client.model.User;
...
public class AssetTest {
    ...
    @Test
    public void testPricingInformationEquals() throws Throwable {
        checkEqualsOnClass(new PricingInformation(), new PricingInformation());
    }
    ...
    public void testStateActionEquals() throws Throwable {
        checkEqualsOnClass(new StateAction(), new StateAction());
    }
