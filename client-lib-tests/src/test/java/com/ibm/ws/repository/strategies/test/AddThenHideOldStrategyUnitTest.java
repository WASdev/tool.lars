...
public class AddThenHideOldStrategyUnitTest {
    ...
    public void testReturnNonBetaResourceOrNull() {
        ...
        assertEquals("Unexpected return comparing betas: ", null, Deencapsulation.invoke(_athos, methodName, esa1, esa2));
        ...
        assertEquals("Unexpected return comparing same beta: ", null, Deencapsulation.invoke(_athos, methodName, esa1, esa2));
        ...
        assertEquals("Unexpected return comparing versions: ", null, Deencapsulation.invoke(_athos, methodName, esa1, esa2));
