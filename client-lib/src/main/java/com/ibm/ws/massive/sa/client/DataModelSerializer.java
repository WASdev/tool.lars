...
public class DataModelSerializer {
     ...
     */
    private static final String DATA_MODEL_PACKAGE = "com.ibm.ws.massive.sa.client.model";
    /**
    ...
    private static void addFieldToJSONObject(Method getter, Object o,
        ...
        try {
            ...
            if (fieldValue instanceof java.lang.String
                ...
                j.put(fieldName, new SimpleDateFormat(DATE_FORMAT_STRING).format(date));
            } else if (fieldValue instanceof Date) {
                j.put(fieldName, new SimpleDateFormat(DATE_FORMAT_STRING).format((Date) fieldValue));
    ...
    public static String serializeAsString(Object o) throws IOException {
        try {
            ...
            throw new IOException("Unable to write JSON for Object", e);
        }
    }
    ...
    public static void serializeAsStream(Object o, OutputStream s) throws IOException {
        try {
            ...
            // the reflective attempt to build the object failed.
            throw new IOException("Unable to build JSON for Object", ise);
        } catch (JSONException ise) {
            throw new IOException("Unable to write JSON for Object", ise);
        }
    }
            ...
            if (value instanceof JSONObject) {
                ...
                if (fieldType != null) {
                    if (fieldType.cls.isEnum()) {
                        ...
                        try {
                            Date d = new SimpleDateFormat(DATE_FORMAT_STRING).parse(value.toString());
                        ...
                        Locale l = RepositoryUtils.localeForString(value.toString());
