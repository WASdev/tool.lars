...
public class RepositoryConnectionList extends ArrayList<RepositoryConnection> {
    ...
    public Collection<EsaResource> getMatchingEsas(ProductDefinition definition) throws RepositoryBackendException {
        Collection<EsaResource> ret = (Collection<EsaResource>) getResources(Collections.singleton(definition), Collections.singleton(ResourceType.FEATURE), null).get(ResourceType.FEATURE);
        if (ret == null) {
    ...
    public Collection<EsaResource> getMatchingEsas(ProductDefinition definition, Visibility visible) throws RepositoryBackendException {
        Collection<EsaResource> ret = (Collection<EsaResource>) getResources(Collections.singleton(definition), Collections.singleton(ResourceType.FEATURE), visible).get(ResourceType.FEATURE);
        if (ret == null) {
            ret = Collections.emptySet();
        }
        return ret;
