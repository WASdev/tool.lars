 ...
 * be stored in the JSON along with the rest of the fields. It is an indicator to {@link DataModelSerializer} that it should create a second object with a "2" on the end of the attribute
 * name.</p>
