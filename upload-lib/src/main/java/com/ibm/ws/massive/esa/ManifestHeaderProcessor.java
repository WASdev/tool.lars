...
public class ManifestHeaderProcessor
{
    ...
    /**
     *
     * Splits a delimiter separated string, tolerating presence of non separator commas within
     * double quoted segments.
     *
     * Eg. com.ibm.ws.eba.helloWorldService;version="[1.0.0, 1.0.0]" &
     ...
     * bundle1;bundle2;other=things<br>
     * bundle1;bundle2<br>
     *
     * @param s data to parse
     * @return a list of NameValuePair, with the Name being the name component, and the Value being
     *         a NameValueMap of key->value mappings.
     */
     ...
     * com.acme.myns;mylist:List<String>="nl,be,fr,uk";myver:Version=1.3;long:Long="1234";d:Double=
     * "3.14";myattr=xyz, com.acme.myns;myattr=abc
     *
     * @param s The header to be parsed
     * @return A list of GenericMetadata objects each representing an individual capability. The
     *         values in the attribute map are of the specified datatype.
     */
