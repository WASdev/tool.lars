...
public class ManifestHeaderProcessor {
    ...
    /**
     *
     * Splits a delimiter separated string, tolerating presence of non separator commas within double
     * quoted segments.
     *
     ...
     * littleredridinghood bundle1;bundle2;other=things bundle1;bundle2
     *
     * @param s data to parse
     * @return a list of NameValuePair, with the Name being the name component, and the Value being a
     *         NameValueMap of key->value mappings.
     */
     ...
     * @return A list of GenericMetadata objects each representing an individual capability. The values
     *         in the attribute map are of the specified datatype.
     */
